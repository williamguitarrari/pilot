...
storiesOf('Components|Balance Total Display', module)
  .add('Enabled Withdraw', () => <BalanceTotalDisplay.EnabledWithdraw />)
  .add('Blocked Withdraw', () => <BalanceTotalDisplay.BlockedWithdraw />)
