  ...
  render () {
    ...
    return (
      ...
      >
        ...
        >
          <ModalTitle
            title={t('settings.company.card.team.table.addUser')}
            titleAlign="center"
          ...
          <ModalContent>
            <p>
              {t('settings.company.card.team.modal.identification')}
            </p>
            ...
            <p>
              <small>
                {t('settings.company.card.team.modal.access_level')}
              </small>
            </p>
            ...
            {status.success &&
              ...
              >
                {t('settings.company.card.team.modal.success',
